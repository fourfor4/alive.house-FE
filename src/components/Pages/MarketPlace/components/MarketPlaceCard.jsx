...
const MarketPlaceCard = ({ status, light, style, data, func }) => {
  ...
  return (
    <div style={{ ...style }} onClick={() => func(localData?.id?.value)}>
      <div
        ...
        className={`border bg-white marketplaceCard border-gray h-[40rem] w-[32rem] relative cursor-pointer`}
      >
        <div
          className={`${
        ...
        <div className="flex justify-center">
          <img
            src={
              "https://cdn.alive.house/artist/esabalu/EsaforWeb.gif" ||
              placeholderImg
            }
        ...
        <div className="flex flex-col items-center">
          <p
            className="text-[48px] text-gray"
            style={{ fontFamily: "Nuform Sans" }}
          >
            {localData?.song_onboarding?.title?.value || "song"}
          </p>
          <p
